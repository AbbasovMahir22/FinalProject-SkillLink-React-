...
const UserCard = ({ user }) => {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-md p-5 hover:shadow-amber-500 transition duration-300 border border-gray-100">
            <div className="flex flex-col items-center text-center">
                ...
                <div className="grid grid-cols-3 gap-4 bg-gray-50 px-4 py-2 rounded-lg text-sm text-gray-700 font-medium mb-4 w-full">
                ...
                <div className="flex gap-3">
                    <button  className="px-5 py-2 cursor-pointer bg-blue-600 text-white rounded-lg text-sm font-semibold hover:bg-blue-700 transition">
                        Follow
                    </button>
                    <Link
                        to={`/userDetail/${user.id}`}
                        className="px-5 py-2 border border-gray-300 rounded-lg text-sm text-gray-700 font-semibold hover:bg-gray-100 transition"
                    >
                        View
                    </Link>
                </div>

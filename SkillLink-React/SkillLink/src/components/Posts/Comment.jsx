...
const Comment = ({ comment, commentDelete, handleEdit, changedHidden, postOwnerId }) => {
    ...
    const isPostOwner = postOwnerId === localStorage.getItem("userId") || comment.isPostOwner;
    ...
    const canSeeComment = !hidden || isPostOwner;
            ...
            {canSeeComment && (
                ...
                >
                    ...
                    <div className="flex-1">
                        ...
                        {comment.isHidden ? (
                            <p className="italic text-gray-400 text-sm">This comment is hidden by the post owner.</p>
                        ) : (

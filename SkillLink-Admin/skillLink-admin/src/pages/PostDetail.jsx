        ...
        <div className="max-w-6xl mx-auto p-4 md:p-8">
            <div className="flex justify-between items-center mb-6">
                ...
                <button
                    ...
                    className="bg-red-600 cursor-pointer hover:bg-red-700 text-white px-4 py-2 rounded transition-all"
                >
                    Delete Post
                </button>
            </div>

            <div className="flex flex-col border-b lg:flex-row gap-6">
                <div className="w-full lg:w-1/2">
                    ...
                    <p className="text-gray-700 whitespace-pre-line">{post.desc}</p>
                </div>

                <div className="w-full lg:w-1/2 ">

                    <div className="space-y-2  max-h-[400px] overflow-y-auto p-2 rounded">
                        {comments.length === 0 ? (
                            ...
                            comments.map((comment) => (
                                <div
                                    ...
                                    className={`border p-1 rounded-md transition-all duration-300 ${highlightCommentId === comment.id.toString() ? "bg-yellow-200 border-red-400" : "bg-cyan-100"
                                        }`}
                                >
                                    <Link to={`/UserDetail/${comment.userId}`}>
                                        <div className="text-xs text-gray-500">
                                            <span className="font-medium text-[18px] text-yellow-600 hover:text-red-500">
